                                    ...
                                    <tbody>
                                        @foreach ($personal_datas as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <x-button tag="a" size="sm" :href="route('admin.cooperative.accompaniment.action', [$item->id, 'action' => ($confirmed ? 'disconfirm' : 'confirm')])">
                                    ...
                                    <tbody>
                                        @foreach ($confirm_assistances as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <x-button tag="a" size="sm" :href="route('admin.cooperative.accompaniment.confirm_show', [$item->id])">
                                                        {{ __('Lihat') }}
                                                    </x-button>
                                                </td>
                                            </tr>
